...
public class CustomAdapter extends ArrayAdapter {
    ...
    public CustomAdapter(Context context, int resource,ArrayList<Items> addContact) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(v==null){
            ...
            holder.btn_delte = (Button)v.findViewById(R.id.btn_delete);
            ...
            holder.btn_edit = (Button) v.findViewById(R.id.btn_edit);
             holder.btn_edit.setOnClickListener(new View.OnClickListener() {
                 @Override
                 public void onClick(View view) {
                     Button btn_edit = (Button)view;
                 }
             });
            ...
            holder.btn_edit.setId(addContact.get(position).get_id());
            v.setTag(holder);
        }
        else{
